...
public class ImagePipelineConfigUtils {
    ...
    public static ImagePipelineConfig getDefaultImagePipelineConfig(Context context) {
        ...
        try {
            baseDirectoryPath = getDiskCacheDir(context);
        } catch (Exception e) {
            e.printStackTrace();
            baseDirectoryPath = context.getApplicationContext().getCacheDir();
        }

        //小图片的磁盘配置 //缓存图片基路径
        DiskCacheConfig diskSmallCacheConfig = DiskCacheConfig.newBuilder(context).setBaseDirectoryPath(baseDirectoryPath)
                //文件夹名
        ...
        DiskCacheConfig diskCacheConfig = DiskCacheConfig.newBuilder(context).setBaseDirectoryPath(baseDirectoryPath)
                //文件夹名
